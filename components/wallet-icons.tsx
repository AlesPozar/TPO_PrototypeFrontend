import type { WalletIcon } from '@/lib/store'
...
export function RoninWalletIcon({ className }: { className?: string }) {
  return (
...
export function ExodusIcon({ className }: { className?: string }) {
  return (
...
export function CoinbaseWalletIcon({ className }: { className?: string }) {
  return (
...
export function RainbowIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 128 128" className={className} aria-label="Rainbow Wallet">
      ...
      <path fill="#FF6B6B" d="M20 80 Q64 20 108 80" stroke="#FF6B6B" strokeWidth="12" fill="none" strokeLinecap="round"/>
      <path fill="none" d="M28 80 Q64 28 100 80" stroke="#FFB347" strokeWidth="10" fill="none" strokeLinecap="round"/>
      <path fill="none" d="M36 80 Q64 36 92 80" stroke="#FFE66D" strokeWidth="8" fill="none" strokeLinecap="round"/>
      <path fill="none" d="M44 80 Q64 44 84 80" stroke="#6BCB77" strokeWidth="6" fill="none" strokeLinecap="round"/>
      <path fill="none" d="M52 80 Q64 52 76 80" stroke="#4D96FF" strokeWidth="4" fill="none" strokeLinecap="round"/>
    </svg>
  )
}
...
export function GenericWalletIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-label="Crypto Wallet">
...
export function WalletIconDisplay({ type, className }: { type: WalletIcon; className?: string }) {
  switch (type) {
    case 'metamask':  return <MetaMaskIcon className={className} />
    case 'trust':     return <TrustWalletIcon className={className} />
    case 'ronin':     return <RoninWalletIcon className={className} />
    case 'phantom':   return <PhantomIcon className={className} />
    case 'exodus':    return <ExodusIcon className={className} />
    case 'ledger':    return <LedgerIcon className={className} />
    case 'coinbase':  return <CoinbaseWalletIcon className={className} />
    case 'rainbow':   return <RainbowIcon className={className} />
    default:          return <GenericWalletIcon className={className} />
  }
}

// Keep old export name for backwards compat with existing imports
export function WalletIcon({ type, className }: { type: WalletIcon; className?: string }) {
  return <WalletIconDisplay type={type} className={className} />
}

export const WALLET_ICON_OPTIONS: { type: WalletIcon; label: string; color: string }[] = [
...
export const WALLET_OPTIONS = WALLET_ICON_OPTIONS
